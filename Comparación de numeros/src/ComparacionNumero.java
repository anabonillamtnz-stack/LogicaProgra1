...
public class ComparacionNumero {
    public static void main(String[] args){
        ...
        System.out.println("Introduzca su segundo número (puede ser en decimales): ");
        double num2 = scanner.nextDouble();

        System.out.println("Introduzca su tercer número (puede ser en decimales): ");
        ...
        System.out.println("Tus números de mayor a menor son: " + "[" + numbers[2] + ", " + numbers[1] + ", " + numbers[0]+ "]");
